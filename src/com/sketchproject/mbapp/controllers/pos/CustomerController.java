...
public class CustomerController {
    ...
    public CustomerController(PosMenuScreen menu, CustomerScreen customer){
        this.menu = menu;
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(validation){
                if(mCustomer.addCustomer(data)){
                    ...
                    menu.showOverlay();
                    NativeDialog dialog = new NativeDialog(menu, "Add Customer", "Tambah Pelanggan Galal, coba lagi", NativeDialog.DIALOG_INFORMATION);
                    dialog.showDialog();
                    menu.hideOverlay();
                }
            }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(validation){
                ...
                if(mCustomer.updateCustomer(data,customerId)){
                    ...
                    menu.showOverlay();
                    NativeDialog dialog = new NativeDialog(menu, "Update Customer", "Tambah pelanggan gagal, coba lagi!", NativeDialog.DIALOG_INFORMATION);
                    dialog.showDialog();
                    menu.hideOverlay();
                }
            }
    ...
    private class HandlerDelete implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(customerId != -1){
                ...
                menu.showOverlay();
                NativeDialog dialog = new NativeDialog(menu, "Delete Customer", "Silakan pilih baris tabel terlebih dahulu!", NativeDialog.DIALOG_INFORMATION);
                dialog.showDialog();
                menu.hideOverlay();                                
            }
        }        
